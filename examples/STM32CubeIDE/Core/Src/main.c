...
HD44780 lcd = {
    ...
    .d6_pin = LCD_D6_Pin,
    .d7_pin = LCD_D7_Pin,
    .interface_8_bit = false,
    .two_lines = true,
    .font_5x10 = false,
};

HD44780_Config lcd_config = {
    .enable_display = true,
    .enable_cursor = true,
    .enable_blink = true,
    .shift_display = false,
...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
    HD44780_init(&lcd, &lcd_config);

    uint8_t symbol_8[8] = {0b00000, 0b01110, 0b10001, 0b11011, 0b10001, 0b01110, 0b01110, 0b00000};
    HD44780_create_symbol(&lcd, 0x04, false, symbol_8);
    HD44780_put_str(&lcd, "\x04 cool skulls \x04\n");

    lcd_config.shift_display = true;
    HD44780_update_config(&lcd, &lcd_config);
    /* USER CODE END 2 */
